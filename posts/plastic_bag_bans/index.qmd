...
Yit, the outcome variable, is the plastic bag percent share of total items 
i, the unit, is the 0.1 latitude/longitude grid cell 
t, the time, is years
Dit, the dummy variable, is one in years after the beginning of a plastic bag policy in unit i
i , a fixed effect, controls for the spatial unit 
i, a fixed effect, controls for year 
...
i, the unit, is the 0.1 latitude/longitude grid cell 
t, the time, is years
Dk(i), the dummy variable, is one if the introduction of the policy was k years away for unit i
i , a fixed effect, controls for the spatial unit 
i, a fixed effect, controls for year 
