...
The bathymetry raster data are sourced from the GEBCO Bathymetric Compilation Group (2025), which provides global seafloor depth information.
...
The EEZ layer contains global Exclusive Economic Zone vector boundaries provided by Marine Regions (v12).
